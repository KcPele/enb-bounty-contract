...
interface IENBBountyNft is IERC721, IERC721Receiver {
...
contract ENBBounty {
    ...
    bool public ENBBountyNftSet = false;
    ...
    function createClaim(
        ...
        ENBBountyNft.mint(address(this), claimId, uri);
    ...
    function _acceptClaim(uint256 bountyId, uint256 claimId) internal {
        ...
        ENBBountyNft.safeTransfer(address(this), bounty.issuer, claimId, '');
