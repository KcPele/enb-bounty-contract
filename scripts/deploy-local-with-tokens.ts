...
async function main() {
  ...
  console.log('    await ENBBounty.createSoloBounty("Task", "Description", winner, 1, {value: ethers.parseEther("1")})');
  console.log('  Creating USDC bounty:');
  console.log('    await MockUSDC.approve(ENBBounty.target, amount)');
  console.log('    await ENBBounty.createSoloBountyToken("Task", "Description", winner, 1, amount, 1)');
  console.log('  Creating ENB bounty:');
  console.log('    await MockENB.approve(ENBBounty.target, amount)');
  console.log('    await ENBBounty.createSoloBountyToken("Task", "Description", winner, 1, amount, 2)');
